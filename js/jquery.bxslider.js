...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var appendControlsAuto = function(){
			slider.controls.start = $('<div class="bx-controls-auto-item"><button type="button" class="bx-start">' + slider.settings.startText + '</button></div>');
			slider.controls.stop = $('<div class="bx-controls-auto-item"><button type="button" class="bx-stop">' + slider.settings.stopText + '</button></div>');
			// add the controls to the DOM
